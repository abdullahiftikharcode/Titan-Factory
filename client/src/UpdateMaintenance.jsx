...
const UpdateMaintenance = () => {
  ...
  return (
    <section className="update-maintenance-container">
      <h1>Update Maintenance</h1>
      <form onSubmit={handleSubmit}>
        <fieldset className="update-maintenance-container__fieldset">
          <label htmlFor="machineId">Machine ID</label>
          <input
            type="text"
            id="machineId"
        ...
        {message && <article className={`message ${message.includes('Error') ? 'error' : 'success'}`}>{message}</article>}
      </form>
    </section>
  );
};
